...
//  except that it takes the transaction as an argument so that its ID may be printed if
//  a race is detected.
//
void
...
void
test_tx
(FILE* fp, size_t item_count, size_t thread_count, size_t tx_count, size_t refs_count, size_t mode)
{
